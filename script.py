...
if myAge >= "18":
    print ("How did you get access to this python script? My creator would never get involved with such old people.")
else:
    print ("Interested on programming? Else I doubt you'd open this python script.")
